...
export default {
  ...
  data() {
    return {
      ...
      selectedItems: [],
      items: [
        {"id": "85808", "item_name": "Adjuvante a base de éster metílico de óleo de soja (720 G/L)", "description": "teste", "unit": "Litro"},
        {"id": "85809", "item_name": "Adjuvante a base de éster metílico de óleo de soja", "description": "teste", "unit": "Metro"},
        {"id": "85810", "item_name": "Adjuvante a base de éster", "description": "teste", "unit": "Unidade"},
        {"id": "85810", "item_name": "Adjuvante a base de éster", "description": "teste", "unit": "Unidade"},
        {"id": "85810", "item_name": "Adjuvante a base de éster", "description": "teste", "unit": "Unidade"},
        {"id": "85810", "item_name": "Adjuvante a base de éster", "description": "teste", "unit": "Unidade"},
        {"id": "85810", "item_name": "Adjuvante a base de éster", "description": "teste", "unit": "Unidade"},
